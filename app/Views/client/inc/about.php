            ...
            <div class="wrap-about">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-padding-right">
                        ...
                        <div class="section-slider height-v-about">
                            <div id="index12" class="owl-carousel  owl-theme">
                                <div class="item">
                                    <img alt="Third slide" src="<?= BASE_URL ?>public/client/images/About/about.jpg" class="img-responsive">
                                </div>
                                <div class="item">
                                    <img alt="Third slide" src="<?= BASE_URL ?>public/client/images/About/about-1.jpg" class="img-responsive">
                                </div>
                            </div>
                        </div>
                        <!-- END / SLIDER -->
                ...
                <div class="about-item about-right">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  no-padding-left col-lg-push-6 col-md-push-6 ">
                        <div class="img">
                            <img src="<?= BASE_URL ?>public/client/images/About/about-1.jpg" alt="#" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-padding-right col-lg-pull-6 col-md-pull-6">
                        <div class="text">
                            <h2 class="heading">WHY GUEST CHOOSE  SKYLINE HOTEL?</h2>
                            <div class="desc">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="team_item text-center">
                            <div class="img">
                                <a href="#"><img src="<?= BASE_URL ?>public/client/images/About/about-3.png" alt="#"></a>
                            </div>
                            <div class="text">
                                <h2>JESSICA ALBA</h2>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="team_item text-center">
                            <div class="img">
                                <a href="#"><img src="<?= BASE_URL ?>public/client/images/About/about-4.png" alt="#"></a>
                            </div>
                            <div class="text">
                                <h2>Robet WILIAM</h2>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="team_item text-center">
                            <div class="img">
                                <a href="#"><img src="<?= BASE_URL ?>public/client/images/About/about-5.png" alt="#"></a>
                            </div>
                            <div class="text">
                                <h2>Adam</h2>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="team_item text-center">
                            <div class="img">
                                <a href="#"><img src="<?= BASE_URL ?>public/client/images/About/about-6.png" alt="#"></a>
                            </div>
                            <div class="text">
                                <h2>David Gari</h2>
                                <span>Lorem lipsum</span>
